/**
 * https://github.com/facebook/lexical/blob/main/packages/lexical-playground/src/plugins/TableActionMenuPlugin/index.tsx
 * https://github.com/facebook/lexical/tree/main/packages/lexical-playground/src/plugins/TableCellResizer/index.tsx
 */
/**
    ...
    >
      ...
      >
        <span className="text">
          왼쪽에
          {' '}
          {selectionCounts.columns === 1 ? '열' : `${selectionCounts.columns} 열`}
          {' '}
          삽입
        </span>
      </button>
