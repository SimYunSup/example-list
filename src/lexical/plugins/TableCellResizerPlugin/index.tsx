// https://github.com/facebook/lexical/blob/v0.13.1/packages/lexical-playground/src/plugins/TableCellResizer/index.tsx
...
export default function TableCellResizerPlugin(): null | JSX.Element {
